...
<!-- Bootstrap Core CSS -->
<link
	href="resources/startbootstrap-agency-gh-pages/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">

<!-- Custom Fonts -->
<link
	href="resources/startbootstrap-agency-gh-pages/vendor/font-awesome/css/font-awesome.min.css"
...
<!-- Theme CSS -->
<link href="resources/startbootstrap-agency-gh-pages/css/agency.min.css"
	rel="stylesheet">
<head>
...
<body id="page-top" class="index" ng-app="routerApp">
	...
	<nav id="mainNav"
		...
		<div class="container">
			...
			<div class="navbar-header page-scroll">
				...
				<a class="navbar-brand page-scroll" href="#">Tobaccoach</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="page-scroll" href="#todayamount">TodayAmount</a></li>
					<li><a class="page-scroll" href="#chart">Chart</a></li>
	...
	<header>
		<div class="container">
			<div class="intro-text">
				<div class="intro-lead-in">Welcome To Tobaccoach!</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal1" class="portfolio-link"
						...
						src="resources/startbootstrap-agency-gh-pages/img/portfolio/roundicons.png"
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal2" class="portfolio-link"
						...
						src="resources/startbootstrap-agency-gh-pages/img/portfolio/startup-framework.png"
						class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal3" class="portfolio-link"
						...
						src="resources/startbootstrap-agency-gh-pages/img/portfolio/treehouse.png"
						class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Treehouse</h4>
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal4" class="portfolio-link"
						...
						src="resources/startbootstrap-agency-gh-pages/img/portfolio/golden.png"
						class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Golden</h4>
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal5" class="portfolio-link"
						...
						src="resources/startbootstrap-agency-gh-pages/img/portfolio/escape.png"
						class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Escape</h4>
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal6" class="portfolio-link"
						...
						src="resources/startbootstrap-agency-gh-pages/img/portfolio/dreams.png"
						class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Dreams</h4>
	...
	<section id="table" >
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">Your Smoking Log Table</h2>
					<h3 class="section-subheading text-muted">Analyze your smoking
						pattern</h3>
				</div>
			</div>
			<div ng-view></div>
	...
	<!-- Todayamount Section -->
	<section id="todayamount" class="bg-light-gray">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">Your Smoking Log Table</h2>
			...
			<div style="text-align: center">
				<h2>Today Amount : ${todayamount.todayamount}</h2>
			</div>
				...
				<div class="col-lg-12">
					<ul class="timeline">
						<li>
							<div class="timeline-image">
								<img class="img-circle img-responsive"
									src="resources/startbootstrap-agency-gh-pages/img/about/1.jpg"
									alt="">
							</div>
						...
						<li class="timeline-inverted">
							<div class="timeline-image">
								<img class="img-circle img-responsive"
									src="resources/startbootstrap-agency-gh-pages/img/about/2.jpg"
									alt="">
							</div>
							<div class="timeline-panel">
								<div class="timeline-heading">
						...
						<li>
							<div class="timeline-image">
								<img class="img-circle img-responsive"
									src="resources/startbootstrap-agency-gh-pages/img/about/3.jpg"
									alt="">
							</div>
							<div class="timeline-panel">
								<div class="timeline-heading">
						...
						<li class="timeline-inverted">
							<div class="timeline-image">
								<img class="img-circle img-responsive"
									src="resources/startbootstrap-agency-gh-pages/img/about/4.jpg"
									alt="">
							</div>
							<div class="timeline-panel">
								<div class="timeline-heading">
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="team-member">
						<img src="resources/startbootstrap-agency-gh-pages/img/team/1.jpg"
				...
				<div class="col-sm-4">
					<div class="team-member">
						<img src="resources/startbootstrap-agency-gh-pages/img/team/2.jpg"
							class="img-responsive img-circle" alt="">
						<h4>Larry Parker</h4>
				...
				<div class="col-sm-4">
					<div class="team-member">
						<img src="resources/startbootstrap-agency-gh-pages/img/team/3.jpg"
							class="img-responsive img-circle" alt="">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-6">
					<a href="#"> <img
						src="resources/startbootstrap-agency-gh-pages/img/logos/envato.jpg"
						class="img-responsive img-centered" alt="">
					</a>
				</div>
				<div class="col-md-3 col-sm-6">
					<a href="#"> <img
						src="resources/startbootstrap-agency-gh-pages/img/logos/designmodo.jpg"
						class="img-responsive img-centered" alt="">
					</a>
				</div>
				<div class="col-md-3 col-sm-6">
					<a href="#"> <img
						src="resources/startbootstrap-agency-gh-pages/img/logos/themeforest.jpg"
						class="img-responsive img-centered" alt="">
					</a>
				</div>
				<div class="col-md-3 col-sm-6">
					<a href="#"> <img
						src="resources/startbootstrap-agency-gh-pages/img/logos/creative-market.jpg"
						class="img-responsive img-centered" alt="">
					</a>
				</div>
			</div>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<img class="img-responsive img-centered"
									src="resources/startbootstrap-agency-gh-pages/img/portfolio/roundicons-free.png"
									alt="">
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="resources/startbootstrap-agency-gh-pages/img/portfolio/startup-framework-preview.png"
									alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="resources/startbootstrap-agency-gh-pages/img/portfolio/treehouse-preview.png"
									alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="resources/startbootstrap-agency-gh-pages/img/portfolio/golden-preview.png"
									alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="resources/startbootstrap-agency-gh-pages/img/portfolio/escape-preview.png"
									alt="">
								<p>
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<img class="img-responsive img-centered"
									src="resources/startbootstrap-agency-gh-pages/img/portfolio/dreams-preview.png"
									alt="">
								<p>
	...
	<!-- jQuery -->
	<script
		src="resources/startbootstrap-agency-gh-pages/vendor/jquery/jquery.min.js"></script>

	<!-- Bootstrap Core JavaScript -->
	<script
		src="resources/startbootstrap-agency-gh-pages/vendor/bootstrap/js/bootstrap.min.js"></script>
	...
	<script
		src="resources/startbootstrap-agency-gh-pages/js/jqBootstrapValidation.js"></script>
	<script src="resources/startbootstrap-agency-gh-pages/js/contact_me.js"></script>

	<!-- Theme JavaScript -->
	<script src="resources/startbootstrap-agency-gh-pages/js/agency.min.js"></script>


	<!-- Request JavaScript -->
	<script src="resources/startbootstrap-agency-gh-pages/js/dataReq.js"
		type="text/javascript"></script>

	<script type="text/javascript"
		src="resources/startbootstrap-agency-gh-pages/js/routerApp.js"></script>
		
		
	<script type="text/javascript"
		src="resources/startbootstrap-agency-gh-pages/js/customerListController.js"></script>
		
	<script type="text/javascript"
		src="resources/startbootstrap-agency-gh-pages/js/customerService.js"></script>
